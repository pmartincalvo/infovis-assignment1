...
def bokeh():
    ...
    return render_template(
        ...
        all_rental_prices=data.all_rental_prices,
        all_rental_prices_text=data.all_rental_prices_text,
        all_surface_areas=data.all_surface_areas,
        all_surface_areas_text=data.all_surface_areas_text,
        selected_property_type=property_type,
        selected_rental_price=rental_price,
        selected_surface_area=surface_area,
        all_metrics=data.all_metrics,
        selected_axis_x=axis_x,
        selected_axis_y=axis_y,
    )
...
def get_data():
    ...
    trained_model = models.train_model(
        data.model_data, data.area_names, data.model_vars
    )
    ...
    all_data = ColumnDataSource(
        data=dict(
            {
                "corporation_rent": data.model_data[axis_x],
                "private_rent": data.model_data[axis_y],
    ...
    if plot is not None:
        ...
        plot = plots.create_hbar(plot_area, plot_data, axis_x=axis_x, axis_y=axis_y)
        return jsonify(
